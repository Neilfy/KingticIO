...
public class KingticIOProgramNodeContribution implements ProgramNodeContribution {
	...
	public void onSendClick(InputEvent event) {
		if (event.getEventType() == InputEvent.EventType.ON_CHANGE) {
			...
			KingticIO io = getInstallation().getIO(idx);
	...
	public void openView() {
		...
		OutputSelect.setItems(getInstallation().getIOItems());
	...
	public void generateScript(ScriptWriter writer) {
		...
		writer.assign("ret", getInstallation().getXMLRPCVariable() + ".send_Command(\"" + cmd + "\")");
